...
; ---------------------------------------------------------------------------------------------
	...
	include "Clone Driver & Sounds/SMPS2ASM - PSG Volume Envelope Equates.asm"
	include "Clone Driver & Sounds/SMPS2ASM - DAC Sample Equates.asm"
    if SMPS_EnablePWM
	include "Clone Driver & Sounds/SMPS2ASM - PWM Sample Equates.asm"
    endif
