...
; Music data
; ---------------------------------------------------------------------------
Music81:	include		"Clone Driver & Sounds/music/Mus81 - GHZ.asm"
		even
Music82:	include		"Clone Driver & Sounds/music/Mus82 - LZ.asm"
		even
Music83:	include		"Clone Driver & Sounds/music/Mus83 - MZ.asm"
		even
Music84:	include		"Clone Driver & Sounds/music/Mus84 - SLZ.asm"
		even
Music85:	include		"Clone Driver & Sounds/music/Mus85 - SYZ.asm"
		even
Music86:	include		"Clone Driver & Sounds/music/Mus86 - SBZ.asm"
		even
Music87:	include		"Clone Driver & Sounds/music/Mus87 - Invincibility.asm"
		even
Music88:	include		"Clone Driver & Sounds/music/Mus88 - Extra Life.asm"
		even
Music89:	include		"Clone Driver & Sounds/music/Mus89 - Special Stage.asm"
		even
Music8A:	include		"Clone Driver & Sounds/music/Mus8A - Title Screen.asm"
		even
Music8B:	include		"Clone Driver & Sounds/music/Mus8B - Ending.asm"
		even
Music8C:	include		"Clone Driver & Sounds/music/Mus8C - Boss.asm"
		even
Music8D:	include		"Clone Driver & Sounds/music/Mus8D - FZ.asm"
		even
Music8E:	include		"Clone Driver & Sounds/music/Mus8E - Sonic Got Through.asm"
		even
Music8F:	include		"Clone Driver & Sounds/music/Mus8F - Game Over.asm"
		even
Music90:	include		"Clone Driver & Sounds/music/Mus90 - Continue Screen.asm"
		even
Music91:	include		"Clone Driver & Sounds/music/Mus91 - Credits.asm"
		even
Music92:	include		"Clone Driver & Sounds/music/Mus92 - Drowning.asm"
		even
Music93:	include		"Clone Driver & Sounds/music/Mus93 - Get Emerald.asm"
		even
