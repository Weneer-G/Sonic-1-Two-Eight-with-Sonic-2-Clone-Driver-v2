...
; Music data
; ---------------------------------------------------------------------------
Music81:	include		"Clone Driver & Sounds/music/81 - 2 Player Menu.asm"
		even
Music82:	include		"Clone Driver & Sounds/music/82 - EHZ.asm"
		even
Music83:	include		"Clone Driver & Sounds/music/83 - MCZ 2P.asm"
		even
Music84:	include		"Clone Driver & Sounds/music/84 - OOZ.asm"
		even
Music85:	include		"Clone Driver & Sounds/music/85 - MTZ.asm"
		even
Music86:	include		"Clone Driver & Sounds/music/86 - HTZ.asm"
		even
Music87:	include		"Clone Driver & Sounds/music/87 - ARZ.asm"
		even
Music88:	include		"Clone Driver & Sounds/music/88 - CNZ 2P.asm"
		even
Music89:	include		"Clone Driver & Sounds/music/89 - CNZ.asm"
		even
Music8A:	include		"Clone Driver & Sounds/music/8A - DEZ.asm"
		even
Music8B:	include		"Clone Driver & Sounds/music/8B - MCZ.asm"
		even
Music8C:	include		"Clone Driver & Sounds/music/8C - EHZ 2P.asm"
		even
Music8D:	include		"Clone Driver & Sounds/music/8D - SCZ.asm"
		even
Music8E:	include		"Clone Driver & Sounds/music/8E - CPZ.asm"
		even
Music8F:	include		"Clone Driver & Sounds/music/8F - WFZ.asm"
		even
Music90:	include		"Clone Driver & Sounds/music/90 - HPZ.asm"
		even
Music91:	include		"Clone Driver & Sounds/music/91 - Options.asm"
		even
Music92:	include		"Clone Driver & Sounds/music/92 - Special Stage.asm"
		even
Music93:	include		"Clone Driver & Sounds/music/93 - Boss.asm"
		even
Music94:	include		"Clone Driver & Sounds/music/94 - Final Boss.asm"
		even
Music95:	include		"Clone Driver & Sounds/music/95 - Ending.asm"
		even
Music96:	include		"Clone Driver & Sounds/music/96 - Super Sonic.asm"
		even
Music97:	include		"Clone Driver & Sounds/music/97 - Invincible.asm"
		even
Music98:	include		"Clone Driver & Sounds/music/98 - Extra Life.asm"
		even
Music99:	include		"Clone Driver & Sounds/music/99 - Title Screen.asm"
		even
Music9A:	include		"Clone Driver & Sounds/music/9A - End of Act.asm"
		even
Music9B:	include		"Clone Driver & Sounds/music/9B - Game Over.asm"
		even
Music9C:	include		"Clone Driver & Sounds/music/9C - Continue.asm"
		even
Music9D:	include		"Clone Driver & Sounds/music/9D - Got Emerald.asm"
		even
Music9E:	include		"Clone Driver & Sounds/music/9E - Credits.asm"
		even
Music9F:	include		"Clone Driver & Sounds/music/9F - Drowning.asm"
		even
